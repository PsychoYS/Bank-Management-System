...
const TransferPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        switch (transferType) {
            case 'internal':
                endpoint = 'http://localhost:5000/api/transfer/internal';
                break;
            case 'external':
                endpoint = 'http://localhost:5000/api/transfer/external';
                break;
            case 'international':
                endpoint = 'http://localhost:5000/api/transfer/international';
                break;
            default:
                return;
        }
